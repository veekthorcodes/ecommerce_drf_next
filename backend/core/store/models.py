...
class Category(MPTTModel):
    ...
    name = models.CharField(verbose_name=_("Category Name"), help_text=_(
        "Required and Unique"), max_length=255, unique=True)
...
class ProductSpecification(models.Model):
    ...
    class Meta:
        verbose_name = _("Product Specificatioin")
...
class Product(models.Model):
    ...
    regular_price = models.DecimalField(verbose_name=_("Regular price"), help_text=_("Maximu 999.99"), error_messages={
        "name": {
            "max_length": _("The price must be between 0 and 999.99.")
        }
    }, max_digits=5, decimal_places=2)
    discount_price = models.DecimalField(verbose_name=_("Discount price"), help_text=_("Maximu 999.99"), error_messages={
        "name": {
            "max_length": _("The price must be between 0 and 999.99.")
        }
    }, max_digits=5, decimal_places=2)
...
class ProductImage(models.Model):
    ...
    image = models.ImageField(verbose_name=_("image"), help_text=_(
        "Upload a product image"), upload_to="images/", default="images/default.png")
    alt_text = models.CharField(verbose_name=_("Alternative text"), help_text=_(
        "Please add and alternative text"), max_length=255, null=True, blank=True)
