    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('regular_price', models.DecimalField(decimal_places=2, error_messages={'name': {'max_length': 'The price must be between 0 and 999.99.'}}, help_text='Maximu 999.99', max_digits=5, verbose_name='Regular price')),
                ('discount_price', models.DecimalField(decimal_places=2, error_messages={'name': {'max_length': 'The price must be between 0 and 999.99.'}}, help_text='Maximu 999.99', max_digits=5, verbose_name='Discount price')),
        ...
        migrations.CreateModel(
            ...
            options={
                'verbose_name': 'Product Specificatioin',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('alt_text', models.CharField(blank=True, help_text='Please add and alternative text', max_length=255, null=True, verbose_name='Alternative text')),
